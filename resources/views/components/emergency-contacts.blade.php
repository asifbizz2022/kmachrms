    ...
    <div class="row">
      <div class="col-md-5">
        <div class="form-group">
          <label for="relation">Relation<i class="hrsale-asterisk">*</i></label>
          <select class="form-control" name="relation" data-plugin="select_hrm" data-placeholder="Select One">
      ...
      <div class="col-md-7">
        <div class="form-group">
          <label for="work_email" class="control-label">Email<i class="hrsale-asterisk">*</i></label>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="form-group">
            <label for="name" class="control-label">Name<i class="hrsale-asterisk">*</i></label>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="form-group">
            <label for="work_phone">Phone<i class="hrsale-asterisk">*</i></label>
            <div class="row">
              <div class="col-md-8">
        ...
        <div class="col-md-7">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-3">
                <input class="form-control" placeholder="Zip Code" name="zipcode" type="text">
              </div>
            </div>
          </div>
        </div>
